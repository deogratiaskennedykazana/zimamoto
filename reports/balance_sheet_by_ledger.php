                                            ...
                                            foreach($ledgers as $ledger){
                                              ...
                                              //  echo "<tr class=' table-secondary'><td></td><td>$ledger[name]</td><td></td></tr>";
                                                ...
                                                if($subs && is_array($subs)){
                                                    ...
                                                    echo "<tr class=' table-second'><td></td><td>$ledger[name]  </td><td>". number_format ($ledgerBalance)."</td></tr>";    
                                                }
                                        ...
                                        if($ledgers && is_array($ledgers)){
                                            foreach($ledgers as $ledger){
                                                ...
                                                if($subs && is_array($subs)){
                                                    ...
                                                    echo "<tr class=' '><td></td><td>$ledger[name] </td><td>". number_format ($ledgerBalance)."</td></tr>";  
                                                }
                                            ...
                                            foreach($ledgers as $ledger){
                                              ...
                                              //  echo "<tr class=' table-success'><td></td><td>$ledger[name] ledger</td><td></td></tr>";
                                                ...
                                                if($subs && is_array($subs)){
                                                    ...
                                                    echo "<tr class=' table-secon'><td></td><td>$ledger[name]  </td><td>". number_format ($ledgerBalance)."</td></tr>";
                                                }
