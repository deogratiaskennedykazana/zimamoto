...
include("../links.php");
$id = $_GET['id'];
$sql ="SELECT subsidiaries.name, voucher.name as voucher, purchase_voucher.* FROM subsidiaries, purchase_voucher, voucher WHERE subsidiaries.id= purchase_voucher.cr_account_id AND voucher.id= purchase_voucher.voucher_type AND purchase_voucher.id='$id'";

$result = $conn->query($sql);
$rows = $result->fetch_assoc();
$customer_id = $rows['cr_account_id'];
...
<div class=" w3-margin-bottom w3-margin-top w3-padding w3-row w3-border-bottom ">
    ...
    <div class=' w3-third ' > <h5>Purchase Voucher Details</h5></div>
    <div class=' w3-third ' > <a href="../pdfs/pv_pdf.php?id=<?php echo $id?>" class=" w3-btn bg-danger">Generate PDF</a> </div>
</div>
<div class=" w3-row">
