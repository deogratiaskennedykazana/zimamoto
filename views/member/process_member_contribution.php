    ...
    <form action="./controllers/member_controllers.php" method="post" class=" was-validated">
            ...
            <div class="card-body table-responsive">
                ...
                <?php
                        ...
                        foreach($data as $member ){
                            ...
                            $name = htmlspecialchars($member[1]) ; // changed to checkno
                            $amount =(float) $member[3];
                            if($amount >0){
                                echo "<tr>";
                                echo "<td>$counter</td>";
                                
                                $member_data = selectMinSubByNameAndCategory($conn, $name, $type);
                                print_r($member_data);
            ...
            <div class=" card-footer">
                <button type="submit" class=" btn btn-sm btn-info btn-block" name="upload_contribution">Upload Data</button>
            </div>
    </form>