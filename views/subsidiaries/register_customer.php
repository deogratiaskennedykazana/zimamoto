<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Register Customer Form</h3>
    </div>
    <form class="was-validated" action="./controllers/subsidiary_controller.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" maxlength="30" class="form-control" required placeholder="Enter Customer Names">
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="card-footer">
            <button type="submit" name="registerCustomer" class="btn btn-primary w-100">Submit</button>
        </div>
    </form>
</div>