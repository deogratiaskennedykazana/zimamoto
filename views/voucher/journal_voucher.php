  ...
  <form action="./controllers/voucher_controller.php" method="post" class="was-validated">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-4 col-sm-12">
          ...
          <select name="branchId" id="branchId" class="form-control select2-form select2bs4-form" required>
              <option option=''>Select Below</option>
            <?php
              $branchId = null;
      ...
      <div class="table-responsive">
        <table id="tv3-table" class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td>
                <select name="deb_account[]" class="min_item form-control select2-form select2bs4-form" required>
              ...
              <td>
                <select name="cr_account[]" class="min_item form-control select2-form select2bs4-form" required>
                  <option value="">Choose below</option>
                  <?php
                    $sql = "SELECT * FROM subsidiaries";
                    $query = mysqli_query($conn, $sql);
    ...
    <div class="card-footer">
      <p class="w3-center" id="vch">
        <button type="submit" class="btn btn-success" name="addjv">POST</button>
      </p>
    </div>
  </form>
</div>
