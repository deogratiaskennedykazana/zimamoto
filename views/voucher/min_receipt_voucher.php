                                        ...
                                        <div class=" card-body">
                                            <form action="./controllers/voucher_controller.php" method="post" class=' was-validated'>
                                                    <div class=" container">
                                                        <div class=" row">
                                                            ...
                                                            <div class='col-sm-10 col-md-3 my-2' >
                                                                ...
                                                                <select name="branch" class="form-control select2-form select2bs4-form" required id="branchId">
                                                                    <?php
                                                                        $branchId = null;
                                                    ...
                                                    <table class=" table table-bordered" id="minrecepttable-1">
                                                        ...
                                                        <tr>
                                                            <td class="deb_acc ">
                                                            <select name="min_item[]" id="min_item" required class=" min_item form-control select2-form select2bs4-form">
                                                             <option value="">select Below</option>
