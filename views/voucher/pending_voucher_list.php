    ...
    <div class=" card-body">
        <table class=" table table-sm table-border table-striped ">
            ...
            $branchId = ($_SESSION['role'] === 'accountant' && $_SESSION['userlevel'] === 'branch') 
                ...
                $vouchers = selectTransactionByStatus($conn, "pending", $branchId);
                    if($vouchers && is_array($vouchers)){
                        ...
                        foreach($vouchers as $voucher){
                            echo "<tr>";
                                    ...
                                    echo "<td>
                                                <a class=' btn btn-info btn-sm ' href='./?page=approve_voucher&voucher_id=$voucher[id]&status=active'>Approve</a>
                                         </td>";
