<div class="card card-primary">
  ...
  <div class='card-body'>
    <form action="./controllers/voucher_controller.php" class="was-validated" method="post">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6 col-sm-12">
          ...
          <?php
            $v = "PJV/";
            $sql = "SELECT COUNT(id) id FROM purchase_voucher";
      ...
      <div class="row mb-3">
        <div class="col-md-6 col-sm-12">
          ...
          <select name="cr_account" class=" form-control select2 select2bs4 "required>
            <option value="">Choose below</option>
            <?php
              $sql = "SELECT * FROM subsidiaries WHERE 1";
              $query = mysqli_query($conn, $sql);
    ...
    <div class="card-footer">
      <button type="submit" class="btn btn-info" name="addpurchvocher">Add</button>
    </div>
  </form>
</div>
